          ...
          <Container>
            ...
            <Grid container spacing={6}>
              <Grid item md={12} xs={12}>
                <Typography className={text.subtitle2}>Experience bettr Services</Typography>
                <Typography  className={text.title}>a better way and a better opportunity</Typography>
                <Typography variant="h2" className={text.subtitle}>
                  
                 Discover the best you with beautyPlayers.com
                </Typography>
              </Grid>
            </Grid>
          </Container>
